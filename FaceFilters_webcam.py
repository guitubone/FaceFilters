...
#        put_blur(frame, [int(x), int(y), int(x+w), int(y+h)])

#        put_debug(frame, landmarks, x, y, w, h)
        Mustache.put(frame, landmarks, w, h, x, y)
#FlowerCrown.put(frame, landmarks, w, h, x, y#)
#        DogNose.put(frame, landmarks, w, h, x, y)
#        DogTongue.put(frame, landmarks, w, h, x, y)
        DogLeftEar.put(frame, landmarks, w, h, x, y)
        DogRightEar.put(frame, landmarks, w, h, x, y)
